        ...
        <div class="col-8 col-lg-4  text-center" id="connectBloc">
            ...
            <fieldset  class="form-group">
                ...
                <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" method="POST" class="d-flex flex-column text-center align-items-center">
                    ...
                    <input type="mail" name="inputMail" id="inputMail" class="mb-4" pattern="^((\w[^\W]+)[\.\-]?){1,}\@(([0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3})|(([a-zA-Z\-0-9]+\.)+[a-zA-Z]{2,}))$" <?= $classError = array_key_exists('lastname', $_SESSION) ? 'class="inputError"':'';?>>
                    <label for="inputPass">Mot de passe : </label>
                    <input type="password" name="inputPass" id="inputPass" <?= $classError = array_key_exists('lastname', $_SESSION) ? 'class="inputError"':'';?>>
